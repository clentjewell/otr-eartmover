  ...
  <main class="content">
    ...
    <article class="page" id="next">
      ...
      <div class="mt28 stagger">
        <div class="row"><div class="row-k">The CORE session</div><div class="row-v">Answer the 22 questions with Clent and David, starting with what counts as this platform working. <strong style="color:var(--white);">A definition of done that Deploy can be measured against.</strong></div></div>
        <div class="row"><div class="row-k">Citation tracking</div><div class="row-v">A repeatable check across the major answer engines, on a fixed question set. <strong style="color:var(--white);">Evidence that the GEO stack works, or does not.</strong></div></div>
        <div class="row"><div class="row-k">Portal logging</div><div class="row-v">Log the questions asked, the abstention rate, and every escalation to David. <strong style="color:var(--white);">The best content brief available, written by buyers.</strong></div></div>
        <div class="row"><div class="row-k">Repository fixes</div><div class="row-v">Seven contradictions found while reading, listed on the Deploy sheet. <strong style="color:var(--white);">Fixed before a buyer or a crawler finds them.</strong></div></div>
      </div>
      <p class="note mt28 reveal">Phase A closes when last month's citations, questions and escalations can be stated from data rather than impression. Nothing else starts until it does.</p>

      <p class="eyebrow amber mt40 reveal" style="margin-bottom:2px;">Phase B &middot; Fill the corpus</p>
      <p class="body reveal" style="margin-top:0;">Run the extraction pipeline on real databooks with keys set, work the review queue to signed-off records, extend the tyre guide and the programmatic surface, and publish the disposal reference nobody has claimed. <strong style="color:var(--white);">Exit test: the published figures match what the platform holds, or the published figures change.</strong></p>

      <p class="eyebrow amber mt40 reveal" style="margin-bottom:2px;">Phase C &middot; Convert it</p>
      <p class="body reveal" style="margin-top:0;">Make the path from a portal answer to a conversation with David explicit and tracked, and tune the reference to the questions buyers actually asked. <strong style="color:var(--white);">Exit test: enquiries arriving through the platform are attributed, and worth more than the cost of running it.</strong></p>
      ...
      <p class="note mt28 reveal">No dates on any of it. Timing gets set with you.</p>

      <div class="rule mt56 reveal"></div>
      <h2 class="h-hero mt40 reveal" style="font-size:clamp(48px,9vw,110px);">Reference.</h2>
      <p class="body grey mt28 reveal">Plainly written. Powered by the trade, not selling for it.</p>
