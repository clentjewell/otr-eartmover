...
.row-v { font-size: 15px; font-weight: 400; color: var(--meta); line-height: 1.65; max-width: 62ch; }
.row.is-exit .row-k { color: var(--orange); }
.row.is-exit .row-v { color: var(--white); }
...
<div class="layout">
  ...
  <main class="content">
    ...
    <article class="page" id="next">
      ...
      <p class="note reveal" style="margin-top:0;">First, before anything else is built</p>
      <div class="mt28 stagger">
        <div class="row"><div class="row-k">The CORE session</div><div class="row-v">Answer the 22 questions with Clent and David, starting with what counts as this platform working.</div></div>
        <div class="row"><div class="row-k">Citation tracking</div><div class="row-v">A repeatable check on whether the major answer engines quote the platform, and on which questions.</div></div>
        <div class="row"><div class="row-k">Portal logging</div><div class="row-v">Log questions asked, the abstention rate, and every escalation to David.</div></div>
        <div class="row"><div class="row-k">Repository fixes</div><div class="row-v">Seven contradictions found while reading, listed on the Deploy sheet.</div></div>
        <div class="row is-exit"><div class="row-k">Exit test</div><div class="row-v">Last month's citations, questions and escalations can be stated from data, not impression.</div></div>
      </div>

      <p class="eyebrow amber mt40 reveal" style="margin-bottom:2px;">Phase B &middot; Fill the corpus</p>
      <p class="note reveal" style="margin-top:0;">Then, once there is something to measure against</p>
      <div class="mt28 stagger">
        <div class="row"><div class="row-k">A real extraction run</div><div class="row-v">Run the pipeline on real databooks with extraction keys set, and work the review queue to signed-off records.</div></div>
        <div class="row"><div class="row-k">The catalogue</div><div class="row-v">Extend the tyre guide and the programmatic surface, and decide the fate of the six unbuilt calculators.</div></div>
        <div class="row"><div class="row-k">The unclaimed subject</div><div class="row-v">Publish the disposal and second-life reference. Every operator faces it and nobody has claimed it.</div></div>
        <div class="row is-exit"><div class="row-k">Exit test</div><div class="row-v">The published figures match what the platform actually holds, or the published figures change.</div></div>
      </div>

      <p class="eyebrow amber mt40 reveal" style="margin-bottom:2px;">Phase C &middot; Convert it</p>
      <p class="note reveal" style="margin-top:0;">Last, once reading can be traced to trade</p>
      <div class="mt28 stagger">
        <div class="row"><div class="row-k">The handover</div><div class="row-v">Make the path from a portal answer to a conversation with David explicit and tracked.</div></div>
        <div class="row"><div class="row-k">The content brief</div><div class="row-v">Tune the reference to the questions buyers actually asked, using the Phase A log as the brief.</div></div>
        <div class="row is-exit"><div class="row-k">Exit test</div><div class="row-v">Enquiries arriving through the platform are attributed, and worth more than the cost of running it.</div></div>
      </div>

      <p class="note mt40 reveal">No dates on any of it. Each phase has to pass its exit test before the next one starts, and timing gets set with you.</p>

      <div class="mt28 stagger">
        <a class="linkrow" href="/pack#sop-deploy" data-view data-title="Deploy, on a page">
          <span class="lr-k">The Deploy sheet in full</span>
          <span class="lr-v">Every phase above with its exit test, the channel plan, the automation triage, and the seven repository contradictions.</span>
          <span class="lr-go">&rarr;</span>
        </a>
      </div>
